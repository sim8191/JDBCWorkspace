...
import com.kh.mvc.model.controller.MemberController;
...
public class MemberView {
    ...
    public void mainMenu() {
        ...
        while(true) {
            ...
            System.out.println("5. 회원 정보 변경"); // 여기 놓침(뻑남)
            System.out.println("6. 회원 탈퇴 기능"); // 여기 놓침(뻑남)
     ...
     * 입력받은 후 변경 요청하는 메소드
     */
    public void updateMember() { // 여기부분 놓침(여길 놓친게 아니라 여기랑 연결되어 있는 부분을 다 놓침)
