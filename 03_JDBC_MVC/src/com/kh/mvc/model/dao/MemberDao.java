...
public class MemberDao {
	...
	{
		try {
			prop.loadFromXML(new FileInputStream("resourcess/member_mapper.xml"));
...
//		String sql = "INSERT INTO MEMBER VALUES(?, ?, ?, ?, ?, ?, ?, ?, SYSDATE)";
		String sql = prop.getProperty("insetMember");
...
//		String sql = "SELECT * FROM MEMBER WHERE MEMBER_ID = ?";
	...
	public List<Member> selectByUserName(Connection conn, String userName) {
		List<Member> list = new ArrayList<Member>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
//		String sql = "SELECT * FROM MEMBER WHERE MEMBER_NAME LIKE ?"; // ? 에들어갈 값 : %이름%
